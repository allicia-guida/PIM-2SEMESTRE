        ...
        // Validar Cadastro
         document.addEventListener("DOMContentLoaded", () => {
            ...
            emailInput.addEventListener("input", () => {
                let regexEmail = /.+@.+\.(com|com\.br)$/;
                if (!regexEmail.test(emailInput.value)) {
                erroEmail.textContent = "O email deve terminar com .com ou .com.br";
                } else {
            ...
            senhaInput.addEventListener("input", () => {
                ...
                erroSenha.textContent = "Inclua pelo menos 1 letra maiúscula.";
                } else if (!/[@$!%*?&]/.test(senha)) {
                erroSenha.textContent = "Inclua pelo menos 1 caractere especial (@$!%*?&).";
                } else {
                erroSenha.textContent = "";
                }
            });

            // validação da confirmação em tempo real
            ...
            document.querySelector("form.cadastro").addEventListener("submit", (event) => {
                if (erroEmail.textContent !== "" || erroSenha.textContent !== "" || erroConfirmar.textContent !== "") {
